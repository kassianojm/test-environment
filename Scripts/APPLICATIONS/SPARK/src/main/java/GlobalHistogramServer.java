...
public class GlobalHistogramServer extends AbstractClusterServer implements Serializable{
    ...
    public static void main(String[] args) throws Exception {(new GlobalHistogramServer()).run(args);}

    protected String getName() {
        return "GlobalHistogramServer";
    }
    ...
    protected void register_spark_application() throws IOException {
                            ...
                            public Iterator<Tuple2<Tuple2<Integer, Integer>, int[]>> call(
                                ...
                                if(nbval > 0) {
                                    ...
                                    for (int i = 0; i <nbval; i++) {
                                        float fl = ByteArrayUtils.byteArrayToFloat(t, i*4);
                                        int c =  ((int)(fl % modulo) + modulo) % modulo;
                                        value[c] += 1;
                                    }
        ...
        JavaPairDStream<Integer, int[]> global = mapWithStateDStream.mapToPair(new PairFunction<Tuple2<Tuple2<Integer,Integer>,int[]>, Integer, int[]>() {
        ...
        JavaMapWithStateDStream<Integer, int[], int[], Tuple2<Integer, int[]>> mapWithStateDStream2 =
                global.mapWithState(StateSpec.function(mappingFunction2).timeout(new Duration(20000)));
