...
public class SparkClusterMPIAInrReceiver extends AbastractReceiver<Tuple2<Tuple2<Integer,Integer>, float[]>> {
     ...
     */
    public SparkClusterMPIAInrReceiver(int port_, String hostname_) throws IOException{
    ...
    private void receive() {
        ...
        AIntUnpacker my_unpacker = new AIntUnpacker();
