...
public class SparkClusterMPIByteArrayUnreliableReceiver extends AbastractReceiver<byte[]> {
     ...
     */
    public SparkClusterMPIByteArrayUnreliableReceiver(int port_, String hostname_) throws IOException{
